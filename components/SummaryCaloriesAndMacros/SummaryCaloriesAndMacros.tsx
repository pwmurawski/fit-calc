...
export default function SummaryCaloriesAndMacros({
    ...
    return (
        <Container href="dailyGoals">
            <Macro>
                <ValueSlider value={toPercent(summaryCalorieMacroData.kcal, limitMacro.kcal)} />
                <CurrentValue>
            ...
            <Macro>
                <ValueSlider value={toPercent(summaryCalorieMacroData.protein, limitMacro.protein)} />
                <CurrentValue>
                    <Name>Białko</Name> {Number(summaryCalorieMacroData.protein.toFixed(1))}
                </CurrentValue>
                <LimitValue>
            ...
            <Macro>
                <ValueSlider value={toPercent(summaryCalorieMacroData.fat, limitMacro.fat)} />
                <CurrentValue>
            ...
            <Macro>
                <ValueSlider value={toPercent(summaryCalorieMacroData.carbs, limitMacro.carbs)} />
                <CurrentValue>
